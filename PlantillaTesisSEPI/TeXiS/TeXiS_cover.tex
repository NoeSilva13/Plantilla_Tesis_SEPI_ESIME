% Fichero que  contiene la portada 
% El contenido  de la  portada se configura  en un fichero  externo en Cascaras/cover.tex
%%%
...
\begin{LARGE}
	\begin{center}
		...
		\vfill
		\begin{Large}
			\textbf{Escuela Superior de Ingeniería Mecánica y Eléctrica}\\
		\end{Large}
		\begin{large}
			\textbf{Unidad Profesional Adolfo López Mateos}
		\end{large}
\newlength{\longTitulo}
...
\vfill
  	...
  	\vfill 
  	\textbf{Ingeniero en Comunicaciones y Electrónica}
  	\vfill
  	Presenta
  	\vfill
...
Asesores
\vfill
\textbf{M. en C. Fabiola Martínez Zúniga} \\ 
\textbf{Dr. Jorge Roberto Sosa Pedroza}  
\\ \mbox{ } \\ \mbox{ } \\ 
